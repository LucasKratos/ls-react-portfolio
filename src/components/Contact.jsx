...
<div name='contact' className='w-full h-screen bg-gradient-to-b 
    ...
    to-gray-800 p-5 
     text-white '>
        ...
        max-w-screen-lg mx-auto sm: mt-20'>
            <div className='pb-8'>
        ...
        <div className=' flex justify-center items-center'>
            <form action="https://getform.io/f/148d4411-3a74-4247-ad90-fb5b0933abef" method='POST' className='flex flex-col w-full md:w-1/2'>
                <input 
                    type="text" 
                    name='name' 
                ...
                />
                 <input 
                    ...
                    className='my-4 p-2 bg-black border-2 rounded-md 
                    text-white focus:outline-none' 
                />
